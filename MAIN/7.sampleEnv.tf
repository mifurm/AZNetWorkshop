...
resource "azurerm_virtual_machine_extension" "enable-apache-01" {
  ...
  settings = <<SETTINGS
    {
        "fileUris": [
        "https://raw.githubusercontent.com/mifurm/AZNetWorkshop/main/MAIN/install-apache-vm01.sh"
        ],
...
resource "azurerm_virtual_machine_extension" "enable-apache-02" {
  ...
  settings = <<SETTINGS
    {
        "fileUris": [
        "https://raw.githubusercontent.com/mifurm/AZNetWorkshop/main/MAIN/install-apache-vm02.sh"
        ],
